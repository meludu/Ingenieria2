<?php
	...
	if ($_SESSION['estado'] == "online") {
		$id_user = $_SESSION['id'];
		$queryProductos = "SELECT idProducto, nombre, descripcionCorta, visitas, fecha_ini, fecha_fin, idGanador FROM productos WHERE estado = '0' AND idUsuario = '".$id_user."' ORDER BY fecha_fin DESC";
                    ...
                    <?php
                      ...
                      while ($result_ofer = mysqli_fetch_array($ejec_ofer)){
                        ...
                        <tr class="radius-ultimo-hijo">
                          ...
                          <td><?php echo $result_ofer['fechaOfer']; ?></td>
                          <td><?php echo $result_ofer['horaOfer']; ?></td>
                          <td>
                            <?php
