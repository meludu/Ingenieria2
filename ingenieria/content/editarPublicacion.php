...
<div class="container">
  ...
  <form class="form-horizontal" role="form" action="?op=editarPubl" method="post"  data-parsley-validate >
    <div class="form-group">
      ...
      <div class="col-md-5">
        <input type="text" name="titulo" class="form-control" id="input-name" maxlength="20" value="<?php echo $tuplaPubMod['nom']; ?>" placeholder="Titulo... " required />
      </div>  
    </div><!-- End Form-->
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
        <textarea class="form-control" name="descCorta" style="resize:none;" rows="3" cols="100" maxlength="150" onKeyDown="contador(this.form.descCorta,this.form.remLen1,150);" onKeyUp="contador(this.form.descCorta,this.form.remLen1,150);" required><?php echo $tuplaPubMod['descCor']; ?></textarea>
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
        <input  style="width: 100px;" type="number" name="cantDias" class="form-control" id="input-name" min="15" max="30" onkeypress="return soloNumeros(event);" placeholder="D&iacute;as... " value="<?php echo $t; ?>" required />
      </div>  
    </div><!-- End Form-->
