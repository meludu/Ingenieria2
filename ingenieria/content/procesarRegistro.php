...
if ($cantidadUser == 0) {
  ...
  $tipoUser = "usuario";
  $estadoU = 0;
  $queryAlta = "INSERT INTO usuarios (tipo, nombre, apellido, sexo, fecha_nac, email, password, imagen, tipoImagen, estado) VALUES ( '".utf8_encode($tipoUser)."', '".utf8_encode($_POST['nombre'])."', '".utf8_encode($_POST['apellido'])."', '".$_POST['sexo']."', '".$fechaMod."', '".$_POST['email_1']."', '".$_POST['clave_1']."', '".null."', '".null."', '".$estadoU."') ";
