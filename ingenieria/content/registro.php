<div class="container">
  ...
  <form class="form-horizontal" role="form" action="content/procesarRegistro.php" method="post" data-parsley-validate >
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
        <input type="password" data-parsley-minlength="8" name="clave_1" class="form-control" id="inputPass" data-parsley-trigger="change" placeholder="Su contrase&ntilde;a" required>
      </div> <!-- End Form-->
    </div> <!-- End Form-->
    <div class="form-group">
      <label for="inputPassAgain" class="col-md-4 control-label">Repetir Password: </label>
      <div class="col-md-5">
        <input type="password" data-parsley-minlength="8" data-parsley-equalto="#inputPass" data-parsley-trigger="change" name="clave_1" class="form-control" id="inputPassAgain" placeholder="Su contrase&ntilde;a nuevamente" required>
      </div> <!-- End Form-->
    </div> <!-- End Form-->
