        ...
        <div class="col-md-3">
            ...
            <div class="col-md-9">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            ?>
                                <div class="item <?php echo $tipo2; ?>">
                                    <img class="slide-image" style="width: 800px; height: 300px;" src="<?php echo $tuplaImg['url']; ?>" alt="">
                                </div>
                                <?php $tipo2 = " "; ?>
                            <?php
                                }
                ...
                <div class="well">
                    ...
                    <?php }?>    
                    <?php
                        if (isset($_SESSION['estado']) && $_SESSION['estado'] == "online") {  // Para escribir un comentario el usuario debe iniciar sesion
                    ?>
