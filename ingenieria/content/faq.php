...
<div class="container">
    ...
    <div class="panel-group" id="accordion">
        <div class="faqHeader"><strong class="colorLetra">Preguntas generales</strong></div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">¿Como funcionan las subastas?</a>
                </h4>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                    En Bestnid el remate es un tanto particular, el bien subastado no se adjudica al postor que mas dinero haya ofrecido, sino que cada postor comunica una necesidad de porque necesita dicho producto (ademas de asignar el precio que estaria dispuesto a pagar por el producto).
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTen">¿Es necesario una cuenta?</a>
                </h4>
            </div>
            <div id="collapseTen" class="panel-collapse collapse">
                <div class="panel-body">
                    Registrarse en Bestnid (Subastas) no es obligatorio, puedes entrar al sitio y echar un vistazo a todos los productos listos para subastarse.
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEleven">¿Que beneficio obtengo al registrarme?</a>
                </h4>
            </div>
            <div id="collapseEleven" class="panel-collapse collapse">
                <div class="panel-body">
                    Al registrarte a Bestnid (Subastas) obtendras muchos beneficios, por ejemplo, podras preguntarle a los vendedores cualquier duda que tengas sobre el producto, ademas de poder pujar en la subasta y publicar tus propios articulos para subastarlos.
                </div>
            </div>
        </div>
        ...
        <div class="faqHeader"><strong class="colorLetra">Ofertar producto</strong></div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
