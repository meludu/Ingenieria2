        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">¿Es necesario una cuenta?</a>
                </h4>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                    Registrarse en Bestnid (Subastas) solo es necesario para poder publicar u ofertar productos.
                </div>
            </div>
        </div>
        <div class="panel panel-default">
