...
<div id="target" class="noti" style="right: 5px; z-index: 9999; padding: 5px; background-color: #D7D5D5;">
		<?php while ($tuplaNoti = mysqli_fetch_array($resNoti)) { ?>
			<a href="?op=modNoti&idP=<?php echo $tuplaNoti['idProducto'];?>&idN=<?php echo $tuplaNoti['idNotificacion'];?>" style="text-decoration:none; color:black;"><div class="display_noti"><?php echo $tuplaNoti['mensaje']; ?></div></a>
			<hr>
		<?php } ?>
